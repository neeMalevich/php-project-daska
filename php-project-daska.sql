...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 23 2024 г., 04:26
...
(2, 'Стул Амазония', 'Описание для Стул Амазония', 230, 400, 1, 5, 2, NULL, 1),
(3, 'Тумба Панормо', 'Описание Тумба Панормо', 475, 600, 4, 4, 1, NULL, 2);
